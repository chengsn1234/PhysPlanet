#!/usr/bin/env python3
"""Convert elevation_map (GridMap) to height_scan (Float32MultiArray) for policy node."""
import numpy as np
import rclpy
...
class ElevationToHeightScan(Node):
    def __init__(self):
        super().__init__('elevation_to_heightscan')
        ...
        self.declare_parameter('base_frame', 'env_0/hunter_link')
